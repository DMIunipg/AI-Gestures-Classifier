...
JNIEXPORT void JNICALL Java_com_unipg_myoclassifierparrot_MyoNativeListener_onEmg(JNIEnv *env,
                                                                            jobject thiz,
                                                                            jint emg0,
                                                                            jint emg1,
                                                                            jint emg2,
...
JNIEXPORT void JNICALL Java_com_unipg_myoclassifierparrot_MyoNativeListener_onQuaternion(JNIEnv *env,
                                                                                   jobject thiz,
                                                                                   jdouble x,
                                                                                   jdouble y,
                                                                                   jdouble z,
...
JNIEXPORT void JNICALL Java_com_unipg_myoclassifierparrot_MyoNativeListener_onAccelerometer(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jdouble x,
                                                                                      jdouble y,
                                                                                      jdouble z)
...
JNIEXPORT void JNICALL Java_com_unipg_myoclassifierparrot_MyoNativeListener_onGyroscope(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jdouble x,
                                                                                  jdouble y,
                                                                                  jdouble z)
