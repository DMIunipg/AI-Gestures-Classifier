...
Java_com_unipg_myoclassifier_MyoNativeClassifierManager_myoClassifierManagerInit(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jint type);

JNIEXPORT void JNICALL
Java_com_unipg_myoclassifier_MyoNativeClassifierManager_myoClassifierManagerLoadModel(JNIEnv *env,
                                                                                      jobject thiz,
                                                                                      jstring path,
                                                                                      jlong pointer);

JNIEXPORT void JNICALL
Java_com_unipg_myoclassifier_MyoNativeClassifierManager_myoClassifierManagerProbabilityFilter(JNIEnv *env,
                                                                                              jobject thiz,
                                                                                              jdouble probability,
                                                                                              jlong pointer);

JNIEXPORT void JNICALL
Java_com_unipg_myoclassifier_MyoNativeClassifierManager_myoClassifierManagerCallback(JNIEnv *env,
                                                                                     jobject thiz,
                                                                                     jobject listener,
                                                                                     jlong pointer);
JNIEXPORT void JNICALL
Java_com_unipg_myoclassifier_MyoNativeClassifierManager_myoClassifierManagerFree(JNIEnv *env,
                                                                                 jobject thiz,
                                                                                 jlong pointer);
